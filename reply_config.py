...
always_reply = [("slok of gene slok", "WINOK"),
                ("i'm blue", "Da ba dee da ba da")]

sometimes_reply = [("kat", "Miauw"),
                   ("hond", "Woef"),
                   ("haan", "Kukeleku"),
                   ("vis", "Blub"),
...
for key, value in always_reply:
    reply_answers.append(ReplyAnswer(value, words_substr_triggers=key))

for key, value in sometimes_reply:
    reply_answers.append(ReplyAnswer(value, words_substr_triggers=key, prob=0.5))

for key, value in rare_reply:
    reply_answers.append(ReplyAnswer(value, words_substr_triggers=key, prob=0.1))
